        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtBrand_Code") {
                    ...
                    document.getElementById("<%= txtRate.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[7].innerText;
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtBrand_Code") {
                    document.getElementById("<%= txtBrand_Code.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                    document.getElementById("<%= txtWt_Per.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[2].innerText;
                    document.getElementById("<%= lblBrandname.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
...
function SelectRow(CurrentRow, RowIndex) {
    ...
    <script type="text/javascript">
        ...
        function itemrate(e) {
            ...
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtRate.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtRate.ClientID %>").val(unit);
                __doPostBack("txtRate", "TextChanged");

            }

        }
        function itemrgate(e) {
            debugger;

            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtIncGstRate.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtIncGstRate.ClientID %>").val(unit);
                __doPostBack("txtIncGstRate", "TextChanged");
        ...
        function EInovice() {
            ...
            window.open('../Utility/pgeEInovice.aspx?dono=' + dono + '&Type=SGCR&ID=' + ID, "_self");
        }
        function GEway() {
         //   var dono = document.getElementById('<%=txtDoc_No.ClientID %>').value;
          //  var ID = document.getElementById('<%=hdnf.ClientID %>').value;
        ...
        function SB(saleid, CRCD) {
            window.open('../Report/pgeGrainSaleBill_Print.aspx?doc_no=' + saleid + '&CRCD=' + CRCD);

        }
        function frt(saleid) {
            window.open('../Report/pgefreightbill.aspx?doc_no=' + saleid);
    ...
    <script type="text/javascript" language="javascript">
        ...
        function pagevalidation() {
            ...
            try {
                ...
                // var freightrate = $("#<%=txtfreightrate.ClientID %>").val();

                var freightrate = $("#<%=txtfreightrate.ClientID %>").val() == "" ? 0 : $("#<%=txtfreightrate.ClientID%>").val();
                ...
                var Hamalichecking = $("#<%=drphamali.ClientID %>").val();
                var NakaDelivery = $("#<%=drpnaka.ClientID %>").val();
                ...
                XML = XML + "<Sale_Head " + DOCNO + " Cash_Credit='" + Cash_Credit + "' Doc_Date='" + Doc_Date + "' Ac_Code ='" + Ac_Code + "' Broker='" + Broker + "' LR_No='" + LR_No + "' Truck_No='" + Truck_No + "'" +
                   ...
                   " Sale_Id='" + Sale_Id + "' EWay_Bill_No='" + EwayBill_No + "' EWayBill_Chk='" + EWay_BillChk +
                   "' EwayBillValidDate='" + EwayBill_ValidDate + "' Einvoice_No='" + Einvoice_No + "' Ack_No='" + Ack_No +
                   "' ac='" + ac + "' IsDelete='1'  bk='" + bk + "' TDS_Rate='" + TDS_Rate + "' TDS_Amt='" + TDS_Amt + "' Hamalichecking='" + Hamalichecking + "' NakaDelivery='" + NakaDelivery + "' freightrate='" + freightrate + "' paytype='" + paytype + "'>";
                ...
                for (var i = 1; i < grdrow.length; i++) {
                    ...
                    XML = XML + "<Ledger TRAN_TYPE='SG' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + saleac + "' " +
                                                           "UNIT_code='0' NARRATION='' AMOUNT='" + Value + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                           "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                           "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + sac + "' vc='0' progid='116' tranid='0'/>";
                ...
                var CashAC = '<%= Session["CashAc"] %>';
                if (Amount > 0) {

                    if (Cash_Credit == "CS") {

                        XML = XML + "<Ledger TRAN_TYPE='SG' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='1' " +
                                                                ...
                                                                "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + CashAC + "' vc='0' progid='116' tranid='0'/>";
                    ...
                    if (paytype == 'G') {
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Ac_Code + "' " +
                                                                 "UNIT_code='0' NARRATION='" + googlepaynarration + "' AMOUNT='" + Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                 "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='" + googlepayac + "' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                 "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + ac + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + googlepayac + "' " +
                                                                  "UNIT_code='0' NARRATION='" + googlepaynarration + "' AMOUNT='" + Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                    ...
                    if (paytype == 'P') {
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Ac_Code + "' " +
                                                                 "UNIT_code='0' NARRATION='" + phonepaynarration + "' AMOUNT='" + Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                 "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='" + phonepay + "' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                                 "SORT_TYPE='SG' SORT_NO='" + Doc_No + "' ac='" + ac + "' vc='0' progid='116' tranid='0'/>";
                        Order_Code = parseInt(Order_Code) + 1;
                        XML = XML + "<Ledger TRAN_TYPE='GP' CASHCREDIT='" + Cash_Credit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + phonepay + "' " +
                                                                  "UNIT_code='0' NARRATION='" + phonepaynarration + "' AMOUNT='" + Amount + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                                  "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='" + Ac_Code + "' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                ...
                <table width="90%" align="left">
                    <tr>
                        <td align="center">
                            ...
                            <asp:Button runat="server" ID="btnPrintSaleBill" Text="Bill" CssClass="btnHelp"
                                OnClick="btnPrintSaleBill_Click" Width="80px" Height="24px" />
                            &nbsp;&nbsp;
                            <asp:Button runat="server" ID="btnfreightletter" Text="Frt" CssClass="btnHelp"
                                OnClick="btnfreightletter_Click" Width="80px" Height="24px" />
                            &nbsp;&nbsp;
                ...
                <table width="90%" align="left" cellspacing="3">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td align="right">Hamali:
                            </td>
                            <td align="left">
                                <asp:DropDownList runat="server" ID="drphamali" TabIndex="8">
                                    <asp:ListItem Text="Yes" Value="Y" Selected="True" />
                                    <asp:ListItem Text="No" Value="N" />
                                </asp:DropDownList>
                                Freight Rate
                             <asp:TextBox ID="txtfreightrate" runat="Server" CssClass="txt" TabIndex="9" Width="200px"
                                 Style="text-align: left;" AutoPostBack="false"
                                 Height="24px"></asp:TextBox>
                                Naka Delivery:
                                          <asp:DropDownList runat="server" ID="drpnaka" TabIndex="10">
                ...
                <asp:Panel ID="Panel2" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                    ...
                    <table width="100%" align="center" cellspacing="5">
                        ...
                        <tr>
                            <td align="left">Item:
                                <asp:TextBox ID="txtItem_Code" runat="Server" CssClass="txt" TabIndex="11" Width="80px"
                                ...
                                <asp:TextBox ID="txtBrand_Code" runat="Server" AutoPostBack="false" CssClass="txt"
                                    ...
                                    TabIndex="12" Width="90px" onkeydown="Brand_Code(event);"></asp:TextBox>
                                ...
                                Qty:
                                <asp:TextBox ID="txtQty" runat="Server" CssClass="txt" TabIndex="13" Width="80px"
                                    Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtQty_TextChanged"></asp:TextBox>

                                WT/Per:
                                <asp:TextBox ID="txtWt_Per" runat="Server" CssClass="txt" TabIndex="14" Width="80px"
                                    Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtWt_Per_TextChanged"></asp:TextBox>

                                Net Qty:
                                <asp:TextBox ID="txtWt_Qty" runat="Server" ReadOnly="true" CssClass="txt" TabIndex="14"
                                    Height="24px" Width="80px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtWt_Qty_TextChanged"></asp:TextBox>
                                Inc Gst Rate:
                                <asp:TextBox ID="txtIncGstRate" runat="Server" CssClass="txt" TabIndex="15" Width="80px"
                                    Height="24px" Style="text-align: right;" onKeyDown="itemrgate(event);" AutoPostBack="false" OnTextChanged="txtIncGstRate_TextChanged"></asp:TextBox>
                                Rate:
                                <asp:TextBox ID="txtRate" runat="Server" CssClass="txt" TabIndex="16" Width="80px"
                                    Height="24px" Style="text-align: right;" onKeyDown="itemrate(event);" AutoPostBack="false" OnTextChanged="txtRate_TextChanged"></asp:TextBox>



                                Value:
                                <asp:TextBox ID="txtValue" runat="Server" CssClass="txt" TabIndex="17" Width="80px"
                        ...
                        <tr>
                            <td>GSTRate Code
                            <asp:TextBox ID="txtGstRate_Code" runat="Server" CssClass="txt" TabIndex="18" Width="80px"
                                ...
                                CGST Amount:
                              <asp:TextBox ID="txtCGST" runat="Server" CssClass="txt" Width="80px" TabIndex="19"
                                  Style="text-align: right;" Height="24px" AutoPostBack="true" OnTextChanged="txtCGST_TextChanged"></asp:TextBox>
                                SGST Amount:
                        <asp:TextBox ID="txtSGST" runat="Server" CssClass="txt" Width="80px" TabIndex="20"
                         ...
                         <asp:TextBox ID="txtIGST" runat="Server" CssClass="txt" Width="80px" AutoPostBack="true"
                             OnTextChanged="txtIGST_TextChanged" TabIndex="20" Style="text-align: right;"
                             Height="24px"></asp:TextBox>

                                &nbsp;&nbsp;
                                      Hamali Rate :
                                <asp:TextBox ID="txtHamali_Rate" runat="Server" CssClass="txt" TabIndex="21" Width="80px"
                                    Height="24px" Style="text-align: left;" AutoPostBack="True"
                                    OnTextChanged="txtHamali_Rate_TextChanged"></asp:TextBox>

                                &nbsp;&nbsp;
                                      Hamali:
                                <asp:TextBox ID="txtHamali" runat="Server" CssClass="txt" TabIndex="22" Width="80px"
                                    Height="24px" Style="text-align: left;" AutoPostBack="True"
                        ...
                        <tr>
                            <td colspan="2" align="left">
                                <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnHelp" Width="80px"
                                    Height="25px" OnClick="btnAdddetails_Click" TabIndex="23" />
                                <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnHelp" Width="80px"
                                    Height="25px" OnClick="btnClosedetails_Click" TabIndex="24" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                    ...
                    <tr>
                        <td align="left" style="width: 60%;">
                            ...
                            <div style="margin-top: 160px; margin-left: 70px;">
                                ...
                                EInvoice No:
                                <asp:TextBox ID="txtEinvoice_No" runat="Server" CssClass="txt" TabIndex="27" Width="120px"
                                    Style="text-align: right;" AutoPostBack="True" Height="24px"></asp:TextBox>
                                ACK No:
                                <asp:TextBox ID="txtAck_No" runat="Server" CssClass="txt" TabIndex="28" Width="150px"
                                    Style="text-align: right;" AutoPostBack="True" Height="24px"></asp:TextBox>
                            ...
                            <td style="width: 80%;" align="left">
                                <table width="130%" cellspacing="4" cellpadding="3">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtTaxable_Amount" runat="Server" CssClass="txt" TabIndex="29" ReadOnly="false"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtCGST_Amount" runat="Server" CssClass="txt" Width="80px" TabIndex="30" ReadOnly="true"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtSGST_Amount" runat="Server" CssClass="txt" Width="82px" TabIndex="31" ReadOnly="true"
                                                Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtIGST_Amount" runat="Server" CssClass="txt" Width="80px" TabIndex="32" ReadOnly="true"
                                                Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    </div>
                                <tr>
                                    ...
                                    <td align="left">
                                        <asp:TextBox ID="txtHamaliAmount" runat="Server" AutoPostBack="True" CssClass="txt"
                                            ...
                                            TabIndex="33" Width="140px"></asp:TextBox>
                                    </td>
                                </tr>
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtpostage" runat="Server" CssClass="txt" TabIndex="34" Width="140px"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAmount" runat="Server" CssClass="txt" ReadOnly="true" TabIndex="35"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtTCS_Par" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                                OnTextChanged="txtTCS_Par_TextChanged" TabIndex="36" Style="text-align: right;"
                                                Height="24px"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtTCS_Amount" runat="Server" AutoPostBack="True" CssClass="txt" Height="24px"
                                                TabIndex="37" OnTextChanged="txtTCS_Amount_TextChanged" ReadOnly="true" Style="text-align: right;"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtTDS" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                                OnTextChanged="txtTDS_TextChanged" TabIndex="38" Style="text-align: right;"
                                                Height="24px"></asp:TextBox>
