...
public partial class Sugar_Master_pgeCompanyParameter : System.Web.UI.Page
{
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Int32 Closing_stock_trading = txtClosing_stock_trading.Text != string.Empty ? Convert.ToInt32(txtClosing_stock_trading.Text) : 0;
            Int32 Closing_stock_BalanceSheet = txtClosing_stock_BalanceSheet.Text != string.Empty ? Convert.ToInt32(txtClosing_stock_BalanceSheet.Text) : 0;
            ...
            if (checkyear == null || checkyear == string.Empty || checkyear == "0")
            {
                ...
                Head_Fields = Head_Fields + "Closing_stock_trading";
                Head_Values = Head_Values + "'" + Closing_stock_trading + "',";
                Head_Fields = Head_Fields + "Closing_stock_BalanceSheet";
                Head_Values = Head_Values + "'" + Closing_stock_BalanceSheet + "'";
                flag = 1;
            ...
            else
            {
                ...
                if (s != string.Empty)
                {
                    ...
                    Head_Update = Head_Update + "Closing_stock_trading=";
                    Head_Update = Head_Update + "'" + Closing_stock_trading + "',";
                    Head_Update = Head_Update + "Closing_stock_BalanceSheet=";
                    Head_Update = Head_Update + "'" + Closing_stock_BalanceSheet + "'";
                    #endregion
                }
                flag = 2;
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    if (dt.Rows.Count > 0)
                    {
                     ...
                     + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
                        ...
                        txtClosing_stock_trading.Text = dt.Rows[0]["Closing_stock_trading"].ToString();
                        lblClosing_stock_trading.Text = clsCommon.getString("select Ac_Name_E from " + qryCommon + " where Ac_Code="
                            + txtClosing_stock_trading.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));


                        txtClosing_stock_BalanceSheet.Text = dt.Rows[0]["Closing_stock_BalanceSheet"].ToString();
                        lblClosing_stock_BalanceSheet.Text = clsCommon.getString("select Ac_Name_E from " + qryCommon + " where Ac_Code="
                            + txtClosing_stock_BalanceSheet.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (hdnfClosePopup.Value == "txtClosing_stock_trading")
            {
                foreach (var s in split)
                {
                    string aa = s.ToString();
            ...
            if (hdnfClosePopup.Value == "txtClosing_stock_BalanceSheet")
            {
                foreach (var s in split)
                {
                    string aa = s.ToString();
    ...
    private void csCalculations()
    {
        try
        {
            ...
            if (strTextBox == "txtClosing_stock_trading")
            {
                if (txtClosing_stock_trading.Text != string.Empty)
                {
                    string str = clsCommon.getString("select Ac_Name_E from " + qryCommon + " where Ac_Code=" + txtClosing_stock_trading.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
                    if (str != string.Empty)
                    {
                        lblClosing_stock_trading.Text = str;
                        setFocusControl(btnUpdate);
                    }
                    else
                    {
                        lblClosing_stock_trading.Text = string.Empty;
                        txtClosing_stock_trading.Text = string.Empty;
                        setFocusControl(txtClosing_stock_trading);
                    }
                }
                else
                {
            ...
            if (strTextBox == "txtClosing_stock_BalanceSheet")
            {
                if (txtClosing_stock_BalanceSheet.Text != string.Empty)
                {
                    string str = clsCommon.getString("select Ac_Name_E from " + qryCommon + " where Ac_Code=" + txtClosing_stock_BalanceSheet.Text + " and Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()));
                    if (str != string.Empty)
                    {
                        lblClosing_stock_BalanceSheet.Text = str;
                        setFocusControl(btnUpdate);
                    }
                    else
                    {
                        lblClosing_stock_BalanceSheet.Text = string.Empty;
                        txtClosing_stock_BalanceSheet.Text = string.Empty;
                        setFocusControl(txtClosing_stock_BalanceSheet);
                    }
                }
                else
                {
    ...
    protected void btnClosing_stock_trading_Click(object sender, EventArgs e)
    {
        try
        {
            pnlPopup.Style["display"] = "block";
            hdnfClosePopup.Value = "txtClosing_stock_trading";
            btnSearch_Click(sender, e);
        }
        catch
        {
    ...
    protected void btnClosing_stock_BalanceSheet_Click(object sender, EventArgs e)
    {
        try
        {
            pnlPopup.Style["display"] = "block";
            hdnfClosePopup.Value = "txtClosing_stock_BalanceSheet";
            btnSearch_Click(sender, e);
        }
        catch
        {
    ...
    protected void txtClosing_stock_BalanceSheet_TextChanged(object sender, EventArgs e)
    {
        searchString = txtClosing_stock_BalanceSheet.Text;
        strTextBox = "txtClosing_stock_BalanceSheet";
        csCalculations();
    }
    protected void txtClosing_stock_trading_TextChanged(object sender, EventArgs e)
    {
        searchString = txtClosing_stock_trading.Text;
        strTextBox = "txtClosing_stock_trading";
        csCalculations();
    }
