...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        document.addEventListener('keyup', function (event) {
            ...
            if (key === 'Escape' || key === 'Esc' || key === 27) {
                ...
                if (hdnfClosePopupValue == "txtClosing_stock_trading") {
                    document.getElementById("<%=txtClosing_stock_trading.ClientID %>").focus();
                }
                if (hdnfClosePopupValue == "txtClosing_stock_BalanceSheet") {
                    document.getElementById("<%=txtClosing_stock_BalanceSheet.ClientID %>").focus();
                 }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function SelectSibling(e) {
            ...
            if (KeyCode == 40) {
                ...
                if (hdnfClosePopupValue == "txtClosing_stock_trading") {
                    document.getElementById("<%=txtClosing_stock_trading.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                       document.getElementById("<%=lblClosing_stock_trading.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
                       document.getElementById("<%=txtClosing_stock_trading.ClientID %>").focus();
                }
                if (hdnfClosePopupValue == "txtClosing_stock_BalanceSheet") {
                    document.getElementById("<%=txtClosing_stock_BalanceSheet.ClientID %>").value = grid.rows[SelectedRowIndex + 1].cells[0].innerText;
                       document.getElementById("<%=lblClosing_stock_BalanceSheet.ClientID %>").innerText = grid.rows[SelectedRowIndex + 1].cells[1].innerText;
                       document.getElementById("<%=txtClosing_stock_BalanceSheet.ClientID %>").focus();
                   }
            }
        }
    ...
    <script type="text/javascript">
        ...
        function Closing_stock_trading(e) {
            ...
            if (e.keyCode == 112) {
                ...
                //$("#<%=pnlPopup.ClientID %>").show();
                $("#<%=hdnfpopup.ClientID%>").val("0");
                $("#<%=btnClosing_stock_trading.ClientID %>").click();

            }
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtClosing_stock_trading.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtClosing_stock_trading.ClientID %>").val(unit);
                __doPostBack("txtClosing_stock_trading", "TextChanged");

            }

        }
        function Closing_stock_BalanceSheet(e) {
            ...
            if (e.keyCode == 112) {
                ...
                //$("#<%=pnlPopup.ClientID %>").show();
                $("#<%=hdnfpopup.ClientID%>").val("0");
                $("#<%=btnClosing_stock_BalanceSheet.ClientID %>").click();

            }
            if (e.keyCode == 9) {
                e.preventDefault();
                var unit = $("#<%=txtClosing_stock_BalanceSheet.ClientID %>").val();

                unit = "0" + unit;
                $("#<%=txtClosing_stock_BalanceSheet.ClientID %>").val(unit);
                __doPostBack("txtClosing_stock_BalanceSheet", "TextChanged");
                    ...
                    <td align="right" style="width: 20%;"> 
                     ...
                     <td align="right" style="width: 20%;"> 
                      ...
                      <tr>
                        ...
                        <td align="left" style="width: 30%;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtClosing_stock_trading" runat="Server" CssClass="txt" TabIndex="34"
                                Height="24px" Width="80px" Style="text-align: right;" OnkeyDown="Closing_stock_trading(event);"
                                AutoPostBack="false"  OnTextChanged="txtClosing_stock_trading_TextChanged"></asp:TextBox>
                            <asp:Button ID="btnClosing_stock_trading" runat="server" Text="..." Height="24px" Width="20px"
                                CssClass="btnHelp" OnClick="btnClosing_stock_trading_Click" />
                            <asp:Label ID="lblClosing_stock_trading" runat="server" CssClass="lblName"></asp:Label>
                        </td>
                        <td align="right" style="width: 20%;">
                            Closing stock BalanceSheet:
                        </td>
                        <td align="left" style="width: 30%;">
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:TextBox ID="txtClosing_stock_BalanceSheet" runat="Server" CssClass="txt" TabIndex="35"
                                Height="24px" Width="80px" Style="text-align: right;" OnkeyDown="Closing_stock_BalanceSheet(event);"
                                AutoPostBack="false"  OnTextChanged="txtClosing_stock_BalanceSheet_TextChanged" ></asp:TextBox>
                            <asp:Button ID="btnClosing_stock_BalanceSheet" runat="server" Text="..." Height="24px" Width="20px"
                                CssClass="btnHelp"  OnClick="btnClosing_stock_BalanceSheet_Click"/>
                            <asp:Label ID="lblClosing_stock_BalanceSheet" runat="server" CssClass="lblName"></asp:Label>
                        </td>
                    </tr>
                          <tr>
                         <td align="right" style="width: 20%;"> 
