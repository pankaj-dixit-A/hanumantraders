    ...
    <script type="text/javascript" language="javascript">
        ...
        function pagevalidation() {
            ...
            try {
                ...
                var bc = document.getElementById("<%= hdnfbc.ClientID %>").value;
                var TDS_Rate = $("#<%=txtTDS.ClientID %>").val() == "" ? 0 : $("#<%=txtTDS.ClientID %>").val();
                var TDS_Amt = $("#<%=txtTDSAmt.ClientID %>").val() == "" ? 0 : $("#<%=txtTDSAmt.ClientID %>").val();
                var vatavrate = $("#<%=txtVatavrate.ClientID %>").val() == "" ? 0 : $("#<%=txtVatavrate.ClientID %>").val();
                var vatavamt = $("#<%=txtvatavamt.ClientID %>").val() == "" ? 0 : $("#<%=txtvatavamt.ClientID %>").val();
                ...
                var frtperqntl = $("#<%=txtFrieghtperqntl.ClientID %>").val() == "" ? 0 : $("#<%=txtFrieghtperqntl.ClientID %>").val();
                ...
                XML = XML + "<Purchase_Head Cash_Credit='" + CashCredit + "'" + DOCNO + " Doc_Date='" + Doc_Date + "' Ac_Code='" + Ac_Code + "' Broker='" + Broker + "' LR_No='" + LR_No + "' Truck_No='" + Truck_No + "' " +
                    ...
                    "PS_Id='" + PS_Id + "' Bill_No='" + Bill_No + "' ac='" + ac + "' bc='" + bc + "' TDS_Rate='" + TDS_Rate +
                    "' TDS_Amt='" + TDS_Amt + "' Frieghtperqntl='" + frtperqntl + "' Vatavrate='" + vatavrate + "' Vatavamt='"+vatavamt+"'>";
                ...
                for (var i = 1; i < grdrow.length; i++) {
                    ...
                    var purcac = gridView.rows[i].cells[23].innerHTML;
                    var pac = gridView.rows[i].cells[24].innerHTML;
                    var ic = gridView.rows[i].cells[22].innerHTML;
                    var FrieghtperqntlDetail = gridView.rows[i].cells[25].innerHTML;
                    ...
                    if (gridView.rows[i].cells[20].innerHTML == "A") {
                        ...
                        "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "' purcac='" + purcac + "' pac='" + pac + "' FrieghtperqntlDetail='"+FrieghtperqntlDetail+"'/>";
                       ...
                       "Value='" + Value + "' GST_Code='" + GST_Code + "' SGST='" + SGST + "' CGST='" + CGST + "' IGST='" + IGST + "' Hamali_Rate='" + Hamali_Rate + "' Hamali='" + Hamali + "' " +
                      "PSDetail_Id='" + psdetailid + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' " +
                       "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "' purcac='" + purcac + "' pac='" + pac + "'/>";
                    }
                    else if (gridView.rows[i].cells[20].innerHTML == "N") {
                        var Sale_Id = gridView.rows[i].cells[13].innerHTML;
                        XML = XML + "<Purchase_Detailstock Cash_Credit='" + CashCredit + "' Doc_No='" + Doc_No + "' detail_id='" + ID + "' PS_Id='" + PS_Id + "' Item_Code='" + Item_Code + "' " +
                            "Brand_Code='" + Brand_Code + "' Qty='" + Qty + "' Wt_Per='" + Wt_Per + "' Wt_Qty='" + Wt_Qty + "' Rate='" + Rate + "' " +
                       "Value='" + Value + "' GST_Code='" + GST_Code + "' SGST='" + SGST + "' CGST='" + CGST + "' IGST='" + IGST + "' Hamali_Rate='" + Hamali_Rate + "' Hamali='" + Hamali + "' " +
                       "PSDetail_Id='" + psdetailid + "' Company_Code='" + Company_Code + "' Year_Code='" + Year_Code + "' Branch_Code='" + Branch_Code + "' " +
                       "Created_By='" + USER + "' Modified_By='" + USER + "' ic='" + ic + "' purcac='" + purcac + "' pac='" + pac + "' FrieghtperqntlDetail='" + FrieghtperqntlDetail + "'/>";
                    ...
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + purcac + "' " +
                                                         "UNIT_code='0' NARRATION='' AMOUNT='" + (parseFloat(Value) + parseFloat(Hamali)) + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                         "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                         "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + pac + "' vc='0' progid='5' tranid='0'/>";
                ...
                if (HamaliAmount > 0) {
                    ...
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' Doc_No='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["TRANSPORT_AC"] %>' + "' " +
                                                            ...
                                                            "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                            "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["TRANSPORT_ACid"] %>' + "' vc='0' progid='6' tranid='0'/>";
            ...
            if (TCS_Amount > 0) {
               ...
               if (TDS_Amt > 0) {
                ...
                if (vatavamt > 0) {
                    ...
                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + Ac_Code + "' " +
                                                          "UNIT_code='0' NARRATION='' AMOUNT='" + vatavamt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                          "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='D' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                          "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + ac + "' vc='0' progid='5' tranid='0'/>";

                    Order_Code = Order_Code + 1;
                    XML = XML + "<Ledger TRAN_TYPE='PG' CASHCREDIT='" + CashCredit + "' DOC_NO='" + Doc_No + "' DOC_DATE='" + Doc_Date + "' AC_CODE='" + '<%=Session["COMMISSION_AC"] %>' + "' " +
                                                      "UNIT_code='0' NARRATION='' AMOUNT='" + vatavamt + "' TENDER_ID='0' TENDER_ID_DETAIL='0' VOUCHER_ID='0' COMPANY_CODE='" + Company_Code + "' " +
                                                      "YEAR_CODE='" + Year_Code + "' ORDER_CODE='" + Order_Code + "' DRCR='C' DRCR_HEAD='0' ADJUSTED_AMOUNT='0' Branch_Code='" + Branch_Code + "' " +
                                                      "SORT_TYPE='PG' SORT_NO='" + Doc_No + "' ac='" + '<%=Session["commissionid"] %>' + "' vc='0' progid='5' tranid='0'/>";
               }
            ...
            <asp:Panel ID="pnlMain" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                    ...
                    <tr>
                        ...
                        <td align="left" colspan="4">
                            <asp:TextBox ID="txtBroker" runat="Server" CssClass="txt" TabIndex="5" Width="80px"
                                Style="text-align: right;" AutoPostBack="True" Height="24px" OnTextChanged="txtBroker_TextChanged"
                                onKeyDown="Broker(event);" Visible="true"></asp:TextBox>
                            <asp:Button ID="btntxtBroker" runat="server" Text="..." CssClass="btnHelp" Height="24px"
                                Width="20px" OnClick="btntxtBroker_Click" Visible="true" />
                            <asp:Label ID="lblBrokerName" runat="server" CssClass="lblName" Visible="true"></asp:Label>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <asp:TextBox ID="txtTruck_No" runat="Server" CssClass="txt" TabIndex="7" Width="200px"
                            ...
                            <asp:TextBox ID="txtbillNo" runat="Server" CssClass="txt" TabIndex="8" Width="200px"
                                ...
                                Height="24px"></asp:TextBox>
                            Frieghtperqntl
                            <asp:TextBox ID="txtFrieghtperqntl" runat="Server" CssClass="txt" TabIndex="9" Width="200px"
                                Style="text-align: left;" AutoPostBack="false" OnTextChanged="txtFrieghtperqntl_TextChanged"
                                Height="24px"></asp:TextBox>
                        </td>
                    </tr>
                </table>
                ...
                <asp:Panel ID="Panel2" runat="server" Font-Names="verdana" Font-Bold="true" ForeColor="Black"
                    ...
                    <table width="100%" align="center" cellspacing="5">
                        ...
                        <tr>
                            <td align="left">Item:
                                <asp:TextBox ID="txtItem_Code" runat="Server" CssClass="txt" TabIndex="10" Width="80px"
                                ...
                                <asp:TextBox ID="txtBrand_Code" runat="Server" AutoPostBack="false" CssClass="txt"
                                    ...
                                    TabIndex="11" Width="90px" onkeydown="Brand_Code(event);"></asp:TextBox>
                                ...
                                Qty:
                                <asp:TextBox ID="txtQty" runat="Server" CssClass="txt" TabIndex="12" Width="80px"
                                    Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtQty_TextChanged"></asp:TextBox>

                                Wet par:
                                <asp:TextBox ID="txtWt_Per" runat="Server" CssClass="txt" TabIndex="13" Width="80px"
                                ...
                                Rate:
                                <asp:TextBox ID="txtRate" runat="Server" CssClass="txt" TabIndex="15" Width="80px"
                                    Height="24px" Style="text-align: right;" AutoPostBack="True" OnTextChanged="txtRate_TextChanged"></asp:TextBox>

                                Value:
                                <asp:TextBox ID="txtValue" runat="Server" CssClass="txt" TabIndex="16" Width="80px"
                        ...
                        <tr>
                            <td>GST Rate Code:
                                <asp:TextBox ID="txtGST_Code" runat="Server" CssClass="txt" TabIndex="17" Width="80px"
                              ...
                              <asp:TextBox ID="txtCGST" runat="Server" CssClass="txt" Width="80px" TabIndex="18"
                                ...
                                SGST Amount:
                        <asp:TextBox ID="txtSGST" runat="Server" CssClass="txt" Width="80px" TabIndex="19"
                         ...
                         <asp:TextBox ID="txtIGST" runat="Server" CssClass="txt" Width="80px" AutoPostBack="true"
                             ...
                             Height="24px"></asp:TextBox>
                                ...
                                Frieghtperqntl
                            <asp:TextBox ID="txtFrieghtperqntldetail" runat="Server" CssClass="txt" TabIndex="23" Width="200px"
                        ...
                        <tr>
                            <td colspan="2" align="left">
                                <asp:Button ID="btnAdddetails" runat="server" Text="ADD" CssClass="btnHelp" Width="80px"
                                    Height="25px" OnClick="btnAdddetails_Click" TabIndex="24" />
                                <asp:Button ID="btnClosedetails" runat="server" Text="Close" CssClass="btnHelp" Width="80px"
                                    Height="25px" OnClick="btnClosedetails_Click" TabIndex="25" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
                            ...
                            <td style="width: 80%;" align="left">
                                <table width="130%" cellspacing="4" cellpadding="3">
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtTaxable_Amount" runat="Server" CssClass="txt" TabIndex="26" ReadOnly="false"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtCGST_Amount" runat="Server" CssClass="txt" Width="80px" TabIndex="27" ReadOnly="true"
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtSGST_Amount" runat="Server" CssClass="txt" Width="82px" TabIndex="28" ReadOnly="true"
                                                Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtIGST_Amount" runat="Server" CssClass="txt" Width="80px" TabIndex="29" ReadOnly="true"
                                                Style="text-align: right;" Height="24px"></asp:TextBox>
                                        </td>
                                    </tr>
                                    </div>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtpostage" runat="Server" CssClass="txt" TabIndex="31" Width="140px"
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:TextBox ID="txtAmount" runat="Server" CssClass="txt" ReadOnly="true" TabIndex="32"
                                    ...
                                    <tr>
                                        <td align="right">Vatav
                                        </td>
                                        <td style="">
                                            <asp:TextBox ID="txtVatavrate" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                                OnTextChanged="txtVatavrate_TextChanged" TabIndex="33" Style="text-align: right;"
                                                Height="24px"></asp:TextBox>
                                            <ajax1:FilteredTextBoxExtender ID="FilteredtxtVatavrate" runat="server" FilterType="Numbers,Custom"
                                                ValidChars="." TargetControlID="txtVatavrate">
                                            </ajax1:FilteredTextBoxExtender>
                                            <asp:TextBox ID="txtvatavamt" runat="Server" AutoPostBack="True" CssClass="txt" Height="24px"
                                                TabIndex="34" OnTextChanged="txtvatavamt_TextChanged" ReadOnly="false" Style="text-align: right;"
                                                Width="98px"></asp:TextBox>
                                            <ajax1:FilteredTextBoxExtender ID="Filteredtxtvatavamt" runat="server" FilterType="Numbers,Custom"
                                                TargetControlID="txtvatavamt" ValidChars=".">
                                            </ajax1:FilteredTextBoxExtender>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="">
                                            ...
                                            <asp:TextBox ID="txtTCS_Amount" runat="Server" AutoPostBack="True" CssClass="txt" Height="24px"
                                                TabIndex="36" OnTextChanged="txtTCS_Amount_TextChanged" ReadOnly="false" Style="text-align: right;"
                                                Width="98px"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td style="">
                                            <asp:TextBox ID="txtTDS" runat="Server" CssClass="txt" Width="42px" AutoPostBack="true"
                                                OnTextChanged="txtTDS_TextChanged" TabIndex="37" Style="text-align: right;"
                                                Height="24px"></asp:TextBox>
                                            ...
                                            <asp:TextBox ID="txtTDSAmt" runat="Server" AutoPostBack="True" CssClass="txt" Height="24px"
                                                ...
                                                Width="72px" TabIndex="38"></asp:TextBox>
