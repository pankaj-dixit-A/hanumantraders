<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptpurchasHamali.aspx.cs" Inherits="Sugar_Report_rptpurchasHamali" %>
...
<body>
   ...
   <div>
        ...
        <CR:CrystalReportViewer ID="CryPurchaseHamali" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
