...
public partial class Sugar_Report_rptgrainpurchaseregister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("crygarinpurchase.rpt"));
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Accode != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrygrainpurchasetegisterforreport where doc_date between '" + datefrom + "' and '" + dateto + "'and Ac_Code='" + Accode
            ...
            else
            {
                ...
                SqlCommand cmd = new SqlCommand("select * from qrygrainpurchasetegisterforreport where doc_date between '" + datefrom + "' and '" + dateto
                    + "' and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()), con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
    ...
    protected void btnMail_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\PurchaseOrder_" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
            rprt1.ExportToDisk(CrystalDecisions.Shared.ExportFormatType.PortableDocFormat, filename);
