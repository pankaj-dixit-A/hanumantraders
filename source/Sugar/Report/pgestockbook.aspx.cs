...
public partial class Sugar_Report_pgestockbook : System.Web.UI.Page
{
    ...
    protected void btnRegisterGain_Click(object sender, EventArgs e)
    {
        string ac_code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:grainstockbookdetail('" + fromDT + "','" + toDT + "','" + ac_code + "')", true);
        pnlPopup.Style["display"] = "none";
