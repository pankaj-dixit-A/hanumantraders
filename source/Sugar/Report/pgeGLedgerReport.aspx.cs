...
public partial class pgeGLedgerReport : System.Web.UI.Page
{
    ...
    #endregion
    protected void btnDayBookSummary_Click(object sender, EventArgs e)
    {
        try
        {
            string fromdt = txtFromDt.Text;
            ...
            pnlPopup.Style["display"] = "none";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "das", "javascript:daybooksummary('" + fromdt + "','" + todt + "')", true);
        }
        catch (Exception eex)
        {
    ...
    protected void btnReport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            todt = DateTime.Parse(todt, System.Globalization.CultureInfo.CreateSpecificCulture("en-GB")).ToString("yyyy/MM/dd");
            pnlPopup.Style["display"] = "none";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "das", "javascript:Report('" + fromdt + "','" + todt + "')", true);
        }
        catch (Exception eex)
        {
        }
    ...
    protected void btnGetDue_Click(object sender, EventArgs e)
    {
        string Ac_Code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:pr('" + fromDT + "','" + toDT + "','" + Ac_Code + "', 'A')", true);
        pnlPopup.Style["display"] = "none";
    }
}