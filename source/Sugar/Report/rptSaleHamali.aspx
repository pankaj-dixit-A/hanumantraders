<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptSaleHamali.aspx.cs" Inherits="Sugar_Report_rptSaleHamali" %>
...
<body>
   ...
   <div>
        ...
        <CR:CrystalReportViewer ID="CrySaleHamali" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
