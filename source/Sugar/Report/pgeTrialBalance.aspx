...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript" language="javascript">
        ...
        function TBU(Doc_Date, Cwhere, FromDt, ToDt, ac_type, group_type) {

            window.open('rptTrialBalanceUdhari.aspx?Doc_Date=' + Doc_Date + '&Cwhere=' + Cwhere + '&FromDt=' + FromDt
             + '&ToDt=' + ToDt + '&ac_type=' + ac_type + '&group_type=' + group_type, '_blank');    //R=Redirected  O=Original
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="pnlMain" runat="server" ForeColor="Black" Font-Size="14px">
        <table width="60%" align="center" cellpadding="10" cellspacing="5">
            ...
            <tr>
                <td>
                     <asp:Button ID="btnUdhari" runat="server" Text="Trail Balance Udhari" CssClass="btnHelp"
                        Width="135px" OnClick="btnUdhari_Click" Height="24px" />
                </td>
                </tr>
        </table>
    </asp:Panel>
