...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function grainstockbookdetail(fromdt, todt, ac_code) {
            window.open('rptgrainstockdetail.aspx?fromdt=' + fromdt + '&todt=' + todt + '&ac_code=' + ac_code);
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="60%" align="center">
        <tr>
            <td align="left" style="width: 40%;">Item Code:
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:HyperLink ID="HyperLink113" runat="server" Target="_blank" NavigateUrl="~/Sugar/Report/rptgrainsoftstockbook.aspx"><span>Grain StockBook</asp:HyperLink>
            </td>
             <td>
                <asp:HyperLink ID="HyperLink1" runat="server" Target="_blank" NavigateUrl="~/Sugar/Report/rptgrainsoftstockbookNew.aspx"><span>Grain StockBook New</asp:HyperLink>
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnRegisterGain" CssClass="btnHelp" Text="Register Gain"
                    Width="180px" Height="24px" OnClick="btnRegisterGain_Click" />
            </td>
