...
public partial class Sugar_Report_rptSaleHamali : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Sale Hamali Register from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("CrySaleHamali.rpt"));
                rprt1.SetDataSource(dt);
                CrySaleHamali.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            cmd = new SqlCommand("select * from qryHamaliSale where Doc_Date between '" + datefrom + "' and '" + dateto
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CrySaleHamali.ReportSource = null;

        CrySaleHamali.Dispose();
