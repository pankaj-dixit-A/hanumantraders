...
public partial class Report_pgeTrialBalance : System.Web.UI.Page
{
    ...
    protected void btnUdhari_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "rptTBS", "javascript:TBU('" + Doc_Date + "','" + Cwhere
                + "','" + FromDate + "','" + ToDate + "','" + ac_type + "','" + group_type + "')", true);
