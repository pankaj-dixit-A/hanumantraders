...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function daybooksummary(fromDT, toDT) {
            window.open('rptDayBooksummary.aspx?FromDt=' + fromDT + '&ToDt=' + toDT, '_blank')
        }
            ...
            <td colspan="4">
                <table align="center" width="60%" cellspacing="5" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            <asp:Button runat="server" ID="btnDayBookSummary" Text="Day Book Summary" CssClass="btnHelp" Width="130px"
                                Height="24px" OnClick="btnDayBookSummary_Click" />
                        </td>
                        <td align="left">
                            <asp:Button runat="server" ID="btnReport" Text="Report" CssClass="btnHelp" Width="130px"
                    ...
                    <tr>
                        ...
                        <td align="left">
                         ...
                         <td>
                <asp:Button Text="Customer Due List" runat="server" ID="btnGetDue" OnClick="btnGetDue_Click"  CssClass="btnHelp"   Height="24px" Width="150px" />
            </td>
                    </tr>
                </table>
            </td>
