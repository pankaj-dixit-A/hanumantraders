<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptGrainPurchaseBrokerReport.aspx.cs" Inherits="Sugar_Report_rptGrainPurchaseBrokerReport" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryGrainPSBrokerReport" runat="server" AutoDataBind="true" />
    </div>
    </form>
</body>
</html>
