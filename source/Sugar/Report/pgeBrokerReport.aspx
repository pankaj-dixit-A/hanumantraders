...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function GPSBroker(accode, FromDt, ToDt) {
            var tn;
            window.open('rptGrainPurchaseBrokerReport.aspx?accode=' + accode + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
        }
        ...
        <tr>
            <td>
                ...
                <asp:Button runat="server" ID="btnAllBrokerDetail" CssClass="btnHelp" OnCommand="Command_Click"
                    ...
                    &nbsp;&nbsp;
                <asp:Button runat="server" ID="btnGrainPSBrokerReport" CssClass="btnHelp"
                    Height="24px" OnCommand="btnGrainPSBrokerReport_Click"   CommandName="BWLPA" Text="Grain Purcahse Broker Report"
                    Width="200px" />
            </td>
        </tr>
        <tr>
