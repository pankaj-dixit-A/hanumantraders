...
public partial class Sugar_Report_rptgrainsaleregister : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("crygrainsaleresgister.rpt"));
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            if (Accode != "0")
            {
                SqlCommand cmd = new SqlCommand("select * from qrygrainsalebillregister where doc_date between '" + datefrom + "' and '" + dateto
                    + "' and Ac_Code='" + Accode + "'  and doc_no!=0 and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()), con);
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrygrainsalebillregister where doc_date between '" + datefrom + "' and '" + dateto
                    + "' and doc_no!=0 and  Company_Code=" + Convert.ToInt32(Session["Company_Code"].ToString()), con);
                cmd.CommandType = CommandType.Text;
                SqlDataAdapter sda = new SqlDataAdapter(cmd);
                sda.Fill(dt);
            }
    ...
    protected void btnPDF_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string filename = filepath + "\\SaleBill" + company_code + "_" + year_code + "_" + DateTime.Now.ToString("ddMMyyyy_HHmmss") + ".pdf";
