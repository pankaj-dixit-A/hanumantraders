...
public partial class Sugar_Report_rptTrialBalanceUdhari : System.Web.UI.Page
{
...
"from qrymstaccountmaster as a,nt_1_gledger as g ";
    ...
    protected void lnkDO_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            string Ac_Code = lnkOV.Text;
            // Session["VOUC_NO"] = no;
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ky", "javascript:sp('" + fromDT + "','" + toDT + "','" + Ac_Code + "', 'A')", true); 
    ...
    protected void dtl_Click(object source, DataListCommandEventArgs e)
    {
        try
        {
            ...
            string accode = e.CommandArgument.ToString();
            // Session["VOUC_NO"] = no;
