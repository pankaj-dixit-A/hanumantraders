...
public partial class Report_pgePurchaseRegister : System.Web.UI.Page
{
    ...
    protected void btnGrainPurchaseReport_Click(object sender, EventArgs e)
    {
    }
    ...
    protected void btnItemwiseSale_Click(object sender, EventArgs e)
    {
        string Ac_Code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:itemwisesale('" + fromDT + "','" + toDT + "','" + Ac_Code + "')", true);
        pnlPopup.Style["display"] = "none";
    }
    ...
    protected void btngrainpurchaseregister_Click(object sender, EventArgs e)
    {
        string Ac_Code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        {
            //hide = "Y";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:gpr('" + fromDT + "','" + toDT + "','" + Ac_Code + "')", true);
        }
        else
        {
            // hide = "Y";
    ...
    protected void btngrainsaleregister_Click(object sender, EventArgs e)
    {
        string Ac_Code = txtAcCode.Text;
        string fromDT = "";
        string toDT = "";
        ...
        {
            //hide = "Y";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:gsr('" + fromDT + "','" + toDT + "','" + Ac_Code + "')", true);
        }
        else
        {
            // hide = "Y";
    ...
    protected void btnHamaliPurchase_Click(object sender, EventArgs e) 
    { 
        string fromDT = "";
        string toDT = "";
        ...
        else
        {
            ...
            //hide = "Y";
            ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:PH('" + fromDT + "','" + toDT + "')", true);
    ...
    protected void btnHamaliSale_Click(object sender, EventArgs e)
    {
        string fromDT = "";
        string toDT = "";
        ...
        //hide = "Y";
        ScriptManager.RegisterClientScriptBlock(this, this.GetType(), "ku", "javascript:SH('" + fromDT + "','" + toDT + "')", true);
