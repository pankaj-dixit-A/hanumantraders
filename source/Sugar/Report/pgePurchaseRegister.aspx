...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function gpr(fromdt, todt, Ac_Code) {
            window.open('rptgrainpurchaseregister.aspx?fromdt=' + fromdt + '&todt=' + todt + '&Ac_Code=' + Ac_Code);    //R=Redirected  O=Original
        }
        ...
        function gsr(fromdt, todt, Ac_Code) {
            //window.open('rptDateWiseSaleRegister.aspx?AcCode=' + Ac_Code + '&FromDt=' + FromDt + '&ToDt=' + ToDt);
            window.open('rptgrainsaleregister.aspx?fromdt=' + fromdt + '&todt=' + todt + ',&Ac_Code=' + Ac_Code);
        }
        ...
        function itemwisesale(fromdt, todt, accode) {
            window.open('pgeItemwiseSale.aspx?fromdt=' + fromdt + '&todt=' + todt + '&accode=' + accode);
        }
        ...
        function PH(fromdt, todt) {

            window.open('rptpurchasHamali.aspx?fromdt=' + fromdt + '&todt=' + todt);
        }
        function SH(fromdt, todt) {

            window.open('rptSaleHamali.aspx?fromdt=' + fromdt + '&todt=' + todt);
        }
    </script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table width="60%" align="center">
        ...
        <tr>
            ...
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="Button2" CssClass="btnHelp" Text="Sale Report"
                    Width="180px" OnClick="btnSaleReport_Click" Height="24px" />
            </td>
        </tr>
        <tr>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btngrainpurchaseregister" CssClass="btnHelp" Text="Grain Purchase Register"
                    Width="180px" Height="24px" OnClick="btngrainpurchaseregister_Click" OnClientClick="Confirm()" />
            </td>
            <td colspan="1" align="center">
                <asp:Button runat="server" ID="btngrainsaleregister" CssClass="btnHelp" Text="Grain Sale Register"
                    Width="180px" Height="24px" OnClick="btngrainsaleregister_Click" OnClientClick="Confirm()" />
            </td>
        </tr>  
        <tr>
         <td colspan="1" align="center">
              <asp:Button runat="server" ID="btnHamaliPurchase" CssClass="btnHelp" Text="Purchase Hamali"
                    Width="180px" Height="24px" OnClick="btnHamaliPurchase_Click"   />
        </td>
        <td colspan="1" align="center">
                <asp:Button runat="server" ID="btnItemwiseSale" CssClass="btnHelp" Text="Itemwise Sale Register"
                    Width="180px" Height="24px" OnClick="btnItemwiseSale_Click"   />
            </td> 
            </tr>
        <tr>
             <td colspan="1" align="center">
            ...
            <td colspan="1" align="center">
                    <asp:Button runat="server" ID="btnHamaliSale" CssClass="btnHelp" Text="Sale Hamali "
                    Width="180px" Height="24px" OnClick="btnHamaliSale_Click"   />
            </td>
        </tr>
    </table>
