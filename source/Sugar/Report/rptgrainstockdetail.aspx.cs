...
public partial class Sugar_Report_rptgrainstockdetail : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Grain Stock Book Detail from " + fromdt + " To " + todt;
                ...
                rprt1.Load(Server.MapPath("cryGrainstockbookdetail.rpt"));
                rprt1.SetDataSource(dt);
                crygrainstockdetail.ReportSource = rprt1;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            {
                SqlCommand cmd = new SqlCommand("select * from qrystockbook where doc_date between'" + datefrom + "' and '" + dateto + "'" +
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.crygrainstockdetail.ReportSource = null;

        crygrainstockdetail.Dispose();
    ...
    protected void crygrainstockdetail_Init(object sender, EventArgs e)
    {
