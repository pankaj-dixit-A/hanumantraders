<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptTrialBalanceUdhari.aspx.cs" Inherits="Sugar_Report_rptTrialBalanceUdhari" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function sp(fromdt, todt, Group_Code, Udharitype) {
            var tn;
        ...
        <asp:Button ID="btnMail" runat="server" Text="Mail" Width="80px" OnClick="btnMail_Click" />
            ...
            <asp:Panel ID="pnlMain" runat="server" align="center" Font-Names="Calibri">
                ...
                <table width="90%" align="center">
                    ...
                    <tr>
                        <td colspan="5" style="border-bottom: double 2px black;"></td>
                    </tr>
                </table>
                <div align="center">
                ...
                <table width="90%" align="center" style="background-color: #FFFFCC;">
                    ...
                    <tr>
                        <td colspan="4" style="border-bottom: solid 1px Navy;"></td>
                    </tr>
                </table>
            </asp:Panel>
        </div>
