...
public partial class Reports_rptSugarBalanceStocks : System.Web.UI.Page
{
    ...
    private void Bindata()
    {
        try
        {
            ...
            string qry1 = "select ID as ID,Buyer,qrybuyer.Ac_Name_E AS buyerbrokerfullname,Sale_Rate as Sale_Rate,Buyer_Quantal,DESPATCH as despatchqty,BALANCE as balance,Tender_No " +
