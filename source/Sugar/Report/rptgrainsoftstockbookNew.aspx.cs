...
public partial class Sugar_Report_rptgrainsoftstockbookNew : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                rprt1.Load(Server.MapPath("crygrainstockBookNew.rpt"));
                rprt1.SetDataSource(dt);
                cryGrainsoftstockbookNew.ReportSource = rprt1;
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.cryGrainsoftstockbookNew.ReportSource = null;

        cryGrainsoftstockbookNew.Dispose();
