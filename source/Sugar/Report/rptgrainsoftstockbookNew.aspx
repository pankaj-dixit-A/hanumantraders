<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptgrainsoftstockbookNew.aspx.cs" Inherits="Sugar_Report_rptgrainsoftstockbookNew" %>
...
<body>
    ...
    <div id="printReady">
        ...
        <CR:CrystalReportViewer ID="cryGrainsoftstockbookNew" runat="server" AutoDataBind="false" />
    </div>
    </form>
</body>
</html>
