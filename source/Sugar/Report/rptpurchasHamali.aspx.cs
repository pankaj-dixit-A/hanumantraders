...
public partial class Sugar_Report_rptpurchasHamali : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (isAuthenticate == "1" || User_Type == "A")
            {
                ...
                pagehead = "Purchase Hamali Register from " + fromdt + " To " + todt;
                Stage1 = Convert.ToDouble(Session["Stage1"]);
                Stage2 = Convert.ToDouble(Session["Stage2"]);
                Stage3 = Convert.ToDouble(Session["Stage3"]);
                ...
                rprt1.Load(Server.MapPath("CryPurchaseHamali.rpt"));
                rprt1.SetDataSource(dt);
                CryPurchaseHamali.ReportSource = rprt1;
          ...
          + Session["Company_Code"].ToString() + "'");
                ...
                rprt1.DataDefinition.FormulaFields["Ten"].Text = "" + Stage1;
                rprt1.DataDefinition.FormulaFields["Thirty"].Text = "" + Stage2;
                rprt1.DataDefinition.FormulaFields["Fifty"].Text = "" + Stage3;
    ...
    private DataTable GetData(string fromdt, string todt)
    {
        ...
        using (SqlConnection con = new SqlConnection(strcon))
        {
            ...
            cmd = new SqlCommand("select * from qryHamaliPurchase where Doc_Date between '" + datefrom + "' and '" + dateto
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        //rprt1.Dispose();
        //GC.Collect();
        this.CryPurchaseHamali.ReportSource = null;

        CryPurchaseHamali.Dispose();
