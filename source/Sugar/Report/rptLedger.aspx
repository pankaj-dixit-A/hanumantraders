...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function Grainbillpurchase(accode, Action, Tran_Type) {

            window.open('../Inword/pgeGrainPurchaseBill.aspx?PS_Id=' + accode + '&Action=' + Action + '&Cash_Credit=' + Tran_Type);
        }

        function Grainbill(accode, Action, Tran_Type) {
            window.open('../Outword/pgeGrainSaleBill.aspx?Sale_Id=' + accode + '&Action=' + Action + '&Cash_Credit=' + Tran_Type);
           // window.open('../Outword/pgeGrainSaleBill.aspx?saleid=' + accode + '&Action=' + Action + '&Cash_Credit=' + Tran_Type);
        }
                                        ...
                                        <td align="left">
                                            <asp:GridView ID="grdDetail" runat="server" AutoGenerateColumns="false" HeaderStyle-BackColor="White"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="No">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="lnkGo" OnClick="lnkGo_Click" Style="color: Background red; text-decoration: none;"
