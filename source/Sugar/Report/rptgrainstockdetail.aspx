<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rptgrainstockdetail.aspx.cs" Inherits="Sugar_Report_rptgrainstockdetail" %>
...
<body>
    ...
    <div>
            ...
            <CR:CrystalReportViewer ID="crygrainstockdetail" runat="server" AutoDataBind="true"
                BestFitPage="False" Width="1500px" OnInit="crygrainstockdetail_Init" />
